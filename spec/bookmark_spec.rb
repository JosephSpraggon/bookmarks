...
describe Bookmark do
  ...
  #     bookmarks = Bookmark.all
  #     expect([bookmarks]).to include(bookmarks)
  #   end
  ...
  describe '.update' do
    it 'updates a given bookmark' do
      bookmark = Bookmark.create(title: 'Makers Academy', url: 'http://makersacademy.com')
      updated_bookmark = Bookmark.update(id: bookmark.id, url: 'http://twitter.com', title: 'Twitter')

      Bookmark.update(id: bookmark.id, url: 'http://twitter.com', title: 'Twitter')
